...
class Dialog(QDialog, FORM_CLASS):
    ...
    def __init__(self, iface, parent=None):
        ...
        self.responsive_elements = {
            ...
            Panels.Query: [
                self.q_push_button_reset,
                self.q_push_button_refresh,
                self.query_grid,
                self.q_push_button_add_row,
                self.q_push_button_show_query,
                self.q_push_button_run_query,
                self.q_push_button_clear_filter,
                self.q_combo_box_layer,
            ],
            Panels.Database: [
                self.dbComboBox,
                self.dmComboBox,
                ...
                self.btn_db_register,
                self.btn_db_open_project,
                self.cb_projects,
                self.db_btn_promote,
            ],
            Panels.Settings: [],
        ...
        try:
            ...
            LOGGER.exception(
                tr(u"Unhandled exception occurred during UI initialization."),
                bar_msg(e),
            )
    ...
    def ask_confirmation(self, title: str, msg: str) -> bool:
        ...
        res = QMessageBox.information(
            self, title, msg, QMessageBox.Ok, QMessageBox.Cancel
        )
    ...
    def closeEvent(self, evt: QtGui.QCloseEvent) -> None:
        ...
        try:
            ...
            LOGGER.exception(
                tr(u"Unhandled exception occurred during UI closing."), bar_msg(e)
            )
    ...
    def on_update_map_layers(self):
        ...
        try:
            ...
            LOGGER.exception(
                tr(u"Unhandled exception occurred while updating map layers."),
                bar_msg(e),
            )
