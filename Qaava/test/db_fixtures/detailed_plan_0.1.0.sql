...
VALUES (E'Asuinalue', E'A', E'Asuinalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
...
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Asuinalue', E'AR', E'Rivitaloalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Asuinalue', E'AO', E'Erillispientaloalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Asuinalue', E'AL', E'Asuin-, liike- ja toimistorakennusten alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Asuinalue', E'AM', E'Maatilojen talouskeskusalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'P', E'Palvelutoiminnot');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'PL', E'Lähipalvelut');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'PV', E'Kulttuuri- ja viihdepalvelut');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'Y', E'Yleiset rakennukset');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'YL', E'Julkiset lähipalvelut');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'YH', E'Hallinto- ja virastopalvelut');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'YO', E'Opetustoiminta');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'YS', E'Sosiaalitoimi ja terveydenhuolto');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'YK', E'Kirkot ja seurakuntatoiminta');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'YU', E'Urheilutoimintaa palvelevien rakennusten alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Keskustatoiminnot', E'C', E'Keskustatoiminnot');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liike- ja toimistorakennusten alue', E'K', E'Liike- ja toimistorakennusten alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liike- ja toimistorakennusten alue', E'KL', E'Liikerakennusten alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liike- ja toimistorakennusten alue', E'KM', E'Vähittäiskaupan suuryksikkö');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liike- ja toimistorakennusten alue', E'KT', E'Toimistorakennusten alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Teollisuusalue', E'T', E'Teollisuusalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
...
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Virkistysalue', E'VP', E'Puisto');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Virkistysalue', E'VL', E'Lähivirkistysalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Virkistysalue', E'VK', E'Leikkipuisto');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Virkistysalue', E'VU', E'Urheilu- ja virkistyspalvelualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Virkistysalue', E'VR', E'Retkeily- ja ulkoilualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Virkistysalue', E'VV', E'Uimaranta');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Loma- ja matkailualue', E'R', E'Loma- ja matkailualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Loma- ja matkailualue', E'RA', E'Lomarakennusten alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Loma- ja matkailualue', E'RM', E'Matkailua palvelevien rakennusten alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Loma- ja matkailualue', E'RL', E'Leirintäalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Loma- ja matkailualue', E'RP', E'Siirtolapuutarha- ja palstaviljelyalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'L', E'Liikennealue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'KATU', E'Katu');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LT', E'Yleisen tien alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LR', E'Rautatie');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LL', E'Lentokenttä');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LS', E'Satama');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LK', E'Kanava');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LV', E'Venesatama ja -valkama');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LP', E'Yleinen pysäköintialue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LPA', E'Autopaikka-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LH', E'Huoltoasema');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LHA', E'Henkilöliikenneterminaali');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LTA', E'Tavaraliikenneterminaali');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'TORI', E'Katuaukio/tori');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'KATU', E'Jalankululle tai pyöräilylle varattu katu');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'E', E'Erityisalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'ET', E'Yhdyskuntatekninen huolto');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EN', E'Energiahuolto');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EJ', E'Jätteenkäsittely');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EO', E'Maa-aineiston otto');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
...
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EMT', E'Mastoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EA', E'Ampumarata');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EP', E'Puolustusvoimienalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EH', E'Hautausmaa');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
...
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Suojelualue', E'SR', E'Rakennussuojelualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Maa- ja metsätalousalue', E'M', E'Maa- ja metsätalousalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Maa- ja metsätalousalue', E'MT', E'Maatalousalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Maa- ja metsätalousalue', E'ME', E'Kotieläintalouden suuryksikkö');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Maa- ja metsätalousalue', E'MP', E'Puutarha- ja kasvihuone');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
...
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi)
VALUES (E'1', E'Melusuojaustarve');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi)
VALUES (E'2', E'Liittymäkielto');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi)
VALUES (E'3', E'Ajoneuvoliittymän likimääräinen sijainti');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi)
VALUES (E'4', E'Rakennuksen sivu, johon rakennus on rakennettava kiinni');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi)
VALUES (E'5', E'Harjasuunta');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi)
VALUES (E'6', E'Ulkoilureitti');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi)
VALUES (E'7', E'Puurivi');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi)
VALUES (E'8', E'Rakennusalan sivu, johon kohdistuu lisätieto');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi)
VALUES (E'9', E'Suojeltava puu');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi)
VALUES (E'10', E'Maanpinnan likimääräinen korkeusasema');
-- ddl-end --
...
ALTER TABLE koodistot.osa_alue_tyyppi
    ADD CONSTRAINT osa_alue_tyyppi_uq UNIQUE (gid_kuvaustyyli);
-- ddl-end --
...
VALUES (E'1', E'asemakaava', E'0.1.0');
-- ddl-end --
