...
ALTER TABLE yleiskaava.maankayttoalue
    ADD CONSTRAINT yleiskaava_fk FOREIGN KEY (uuid_yleiskaava)
...
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'1', E'Asuinalue', E'A', E'Asuntoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'2', E'Asuinalue', E'AK', E'Kerrostalovaltainen asuntoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'3', E'Asuinalue', E'AP', E'Pientalovaltainen asuntoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'4', E'Asuinalue', E'AT', E'Kyläalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'5', E'Keskustatoiminnot', E'C', E'Keskustatoimintojen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'6', E'Liike- ja toimistorakennusten alue', E'KM',
        E'Kaupallisten palvelujen alue, jolle saa sijoittaa vähittäiskaupan suuryksikön');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'7', E'Palvelutoiminnot', E'P', E'Palvelujen ja hallinnon alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'8', E'Palvelutoiminnot', E'PL', E'Lähipalvelujen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'9', E'Palvelutoiminnot', E'PY', E'Julkisten palvelujen ja hallinnon alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'10', E'Työpaikka-alue', E'TP', E'Työpaikka-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'11', E'Teollisuusalue', E'T', E'Teollisuus- ja varastoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'12', E'Teollisuusalue', E'TT', E'Ympäristövaikutuksiltaan merkittävien teollisuustoimintojen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'13', E'Teollisuusalue', E'TY',
        E'Teollisuusalue, jolla ympäristö asettaa toiminnan laadulle erityisiä vaatimuksia');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'14', E'Teollisuusalue', E'TV', E'Varastoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'15', E'Teollisuusalue', E'T/kem',
        E'Teollisuus- ja varastoalue, jolla on/jolle saa sijoittaa merkittävän, vaarallisia kemikaaleja valmistavan tai varastoivan laitoksen');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'16', E'Virkistysalue', E'V', E'Virkistysalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'17', E'Virkistysalue', E'VL', E'Lähivirkistysalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'18', E'Virkistysalue', E'VU', E'Urheilu- ja virkistyspalvelujen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'19', E'Virkistysalue', E'VR', E'Retkeily- ja ulkoilualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'20', E'Loma- ja matkailualue', E'R', E'Loma- ja matkailualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'21', E'Loma- ja matkailualue', E'RA', E'Loma-asuntoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'22', E'Loma- ja matkailualue', E'RM', E'Matkailupalvelujen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'23', E'Loma- ja matkailualue', E'RL', E'Leirintäalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'24', E'Loma- ja matkailualue', E'RV', E'Asuntovaunualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'25', E'Loma- ja matkailualue', E'RP', E'Siirtolapuutarha-/palstaviljelyalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'26', E'Liikenteen alue', E'L', E'Liikennealue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'27', E'Liikenteen alue', E'LT', E'Yleisen tien alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'28', E'Liikenteen alue', E'KATU', E'Katualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'29', E'Liikenteen alue', E'LHA', E'Henkilöliikenteen terminaalialue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'30', E'Liikenteen alue', E'LTA', E'Tavaraliikenteen terminaalialue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'31', E'Liikenteen alue', E'LH', E'Huoltoasema-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'32', E'Liikenteen alue', E'LR', E'Rautatieliikenteen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'33', E'Liikenteen alue', E'LL', E'Lentoliikenteen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'34', E'Liikenteen alue', E'LS', E'Satama-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'35', E'Erityisalue', E'E', E'Erityisalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'36', E'Erityisalue', E'ET', E'Yhdyskuntateknisen huollon alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'37', E'Erityisalue', E'EN', E'Energiahuollon alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'38', E'Erityisalue', E'EJ', E'Jätteenkäsittelualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'39', E'Erityisalue', E'EO', E'Maa-ainesten ottoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'40', E'Erityisalue', E'EK', E'Kaivosalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'41', E'Erityisalue', E'EA', E'Ampumarata-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'42', E'Erityisalue', E'EP', E'Puolustusvoimien alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'43', E'Erityisalue', E'EH', E'Hautausmaa-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'44', E'Erityisalue', E'EV', E'Suojaviheralue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'45', E'Suojelualue', E'S', E'Suojelualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'46', E'Suojelualue', E'SL', E'Luonnonsuojelualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'47', E'Suojelualue', E'SM', E'Muinaismuistoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'48', E'Suojelualue', E'SR', E'Rakennuslainsäädännön nojalla suojeltava alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'49', E'Suojelualue', E'SRS', E'Rakennussuojelulain nojalla suojeltu alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'50', E'Maa- ja metsätalousalue', E'M', E'Maa- ja metsätalousvaltainen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'51', E'Maa- ja metsätalousalue', E'MT', E'Maatalousalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'52', E'Maa- ja metsätalousalue', E'ME', E'Kotieläintalouden suuryksikön alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'53', E'Maa- ja metsätalousalue', E'MA', E'Maisemallisesti arvokas peltoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'54', E'Maa- ja metsätalousalue', E'MU',
        E'Maa- ja metsätalousvaltainen alue, jolla on erityistä ulkoilun ohjaamistarvetta');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'55', E'Maa- ja metsätalousalue', E'MY',
        E'Maa- ja metsätalousvaltainen alue, jolla on erityisiä ympäristöarvoja');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (gid, paaluokka, koodi, nimike)
VALUES (E'56', E'Vesialue', E'W', E'Vesialue');
-- ddl-end --
...
ALTER TABLE yleiskaava.yleiskaava
...
VALUES (E'1', E'yleiskaava');
-- ddl-end --
INSERT INTO koodistot.kaavatyyppi (gid, nimi)
VALUES (E'2', E'osayleiskaava');
-- ddl-end --
INSERT INTO koodistot.kaavatyyppi (gid, nimi)
VALUES (E'3', E'vaiheyleiskaava');
-- ddl-end --
INSERT INTO koodistot.kaavatyyppi (gid, nimi)
VALUES (E'4', E'strateginen yleiskaava');
-- ddl-end --
INSERT INTO koodistot.kaavatyyppi (gid, nimi)
VALUES (E'5', E'maaseutuosayleiskaava');
-- ddl-end --
INSERT INTO koodistot.kaavatyyppi (gid, nimi)
VALUES (E'6', E'taajamayleiskaava');
-- ddl-end --
INSERT INTO koodistot.kaavatyyppi (gid, nimi)
VALUES (E'7', E'kyläkaava');
-- ddl-end --
INSERT INTO koodistot.kaavatyyppi (gid, nimi)
VALUES (E'8', E'harjuosayleiskaava');
-- ddl-end --
INSERT INTO koodistot.kaavatyyppi (gid, nimi)
VALUES (E'9', E'rantaosayleiskaava');
-- ddl-end --
INSERT INTO koodistot.kaavatyyppi (gid, nimi)
VALUES (E'10', E'viherkaava');
-- ddl-end --
INSERT INTO koodistot.kaavatyyppi (gid, nimi)
VALUES (E'11', E'kuntien yhteinen yleiskaava');
-- ddl-end --
...
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'1', E'Maisemallisesti arvokas alue', E'ma', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'2', E'Kaupunki- tai kyläkuvallisesti arvokas alue', E'sk', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'3', E'Alue, jolla on säilytettäviä ympäristöarvoja', DEFAULT, E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'4', E'Arvokas harjualue tai muu geologinen muodostuma', E'ge', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'5', E'Tärkeä tai vedenhankintaan soveltuva pohjavesialue', E'pv', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'6', E'Natura 2000 -verkostoon kuuluva tai ehdotettu alue', E'nat', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'7', E'Luonnon monimuotoisuuden kannalta erityisen tärkeä alue', E'luo', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'8', E'UNESCO:n maailmanperintökohde', E'un', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'9', E'Kansallinen kaupunkipuisto', E'kp', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'10', E'Melualue', E'me', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'11', E'Puhdistettava/kunnostettava maa-alue', E'saa', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'12', E'Vaara-alue', E'va', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'13', E'Suojavyöhyke', E'sv', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'14', E'Kehittämisalue', E'ke', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'15', E'Suunnittelutarvealue', E'st', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'16', E'Alue, jolla ympäristö säilytetään', E'/s', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'17', E'Tuulivoimaloiden alue', E'tv', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'18', E'Maanalainen tila', DEFAULT, E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'19', E'Maanalainen tila, jota käytetään mmyös väestösuojana', E'mav', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'20', E'Alue on varattu kunnan tarpeisiin', E'/k', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'21', E'Alue on varattu valtion tarpeisiin', E'/v', E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'22', E'Nykyisellään säilyvät alueet', DEFAULT, E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'23', E'Pienin toimenpitein kehitettävät alueet', DEFAULT, E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'24', E'Uudet ja olennaisesti muuttuvat alueet', DEFAULT, E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'25', E'Yhdyskuntarakenteen mahdollinen laajenemisalue', DEFAULT, E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'26', E'Alueen tiivistämis-/eheyttämistarve', DEFAULT, E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'27', E'Alueen raja', DEFAULT, E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'28', E'Osa-alueen raja', DEFAULT, E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'29', E'Ohjeellinen alueen tai osa-alueen raja', DEFAULT, E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'30', E'Moottori- tai moottoriliikennetie', E'mo', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'31', E'Kaksiajoratainen päätie/-katu', E'vt/kt/st/pk', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'32', E'Valtatie/kantatie', E'vt/kt', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'33', E'Seututie/pääkatu', E'st/pk', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'34', E'Yhdystie/kokoojakatu', E'yt/kk', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'35', E'Joukkoliikenteelle varattu tie tai katu', E'jl', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'36', E'Liittymä', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'37', E'Eritasoliittymä', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'38', E'Suuntaisliittymä', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'39', E'Eritasoristeys ilman liittymää', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'40', E'Liikennetunneli', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'41', E'Päärata ja liikennepaikka', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'42', E'Yhdysrata/sivurata/kaupunkirata', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'43', E'Ulkoilureitti', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'44', E'Kevyen liikenteen reitti', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'45', E'Moottorikelkkailureitti', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'46', E'Laivaväylä', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'47', E'Veneväylä', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'48', E'Johto tai linja', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'49', E'Nykyiset tiet ja linjat', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'50', E'Merkittävästi parannettava tieosuus', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'51', E'Uudet tiet ja linjat', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'52', E'Poikkiviiva osoittaa rajan sen puolen johon merkintä kohdistuu', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'53', E'Yhdyskuntarakenteen laajenemissuunta', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'54', E'Ohjeellinen/vaihtoehtoinen tielinjaus', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'55', E'Tieliikenteen yhteystarve', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'56', E'Joukkoliikenteen kehittämiskäytävä/yhteystarve', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'57', E'Kevyen liikenteen yhteystarve', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'58', E'Viheryhteystarve', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'59', E'Meluntorjuntatarve', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'60', E'Keskustatoimintojen alakeskus', E'ca', E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'61', E'Lähipalvelujen alue', E'pl', E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'62', E'Suojelu-/muinaismuistokohde', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'63', E'Virkistys-/matkailukohde', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'64', E'Linja-autoasema/julkisen liikenteen vaihtopaikka/matkakeskus', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'65', E'Rautatieasema', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'66', E'Venesatama/venevalkama', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'67', E'Uimaranta', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'68', E'Kohde, nykyinen', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'69', E'Kohde, uusi', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'70', E'Alueeseen tai kohteeseen liittyvä kirjain- tai numerotunnus', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'71', E'Kunnan nimi', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'72', E'Kunnan osan nimi', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'73', E'Alakeskuksen/kyläkeskuksen nimi', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'74', E'Ympäristö- tai maisemavaurion korjaustarve', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'75', E'Terveyshaitan poistamistarve', DEFAULT, E'3');
-- ddl-end --
...
ALTER TABLE koodistot.maankayttoluokka
    ADD CONSTRAINT kuvaustyyli_fk FOREIGN KEY (gid_kuvaustyyli)
...
ALTER TABLE koodistot.maankayttoluokka
    ADD CONSTRAINT maankayttoluokka_uq UNIQUE (gid_kuvaustyyli);
-- ddl-end --
...
ALTER TABLE koodistot.kaavaelementti_tyyppi
    ADD CONSTRAINT kaavaelementti_tyyppi_uq UNIQUE (gid_kuvaustyyli);
-- ddl-end --
...
VALUES (E'1', E'aloitusvaihe', DEFAULT);
-- ddl-end --
INSERT INTO koodistot.vaihetieto (gid, nimi, kuvaus)
VALUES (E'2', E'valmisteluvaihe', DEFAULT);
-- ddl-end --
INSERT INTO koodistot.vaihetieto (gid, nimi, kuvaus)
VALUES (E'3', E'luonnosvaihe', DEFAULT);
-- ddl-end --
INSERT INTO koodistot.vaihetieto (gid, nimi, kuvaus)
VALUES (E'4', E'ehdotusvaihe', DEFAULT);
-- ddl-end --
INSERT INTO koodistot.vaihetieto (gid, nimi, kuvaus)
VALUES (E'5', E'hyväksymisvaihe', DEFAULT);
-- ddl-end --
INSERT INTO koodistot.vaihetieto (gid, nimi, kuvaus)
VALUES (E'6', E'hyväksytty', DEFAULT);
-- ddl-end --
INSERT INTO koodistot.vaihetieto (gid, nimi, kuvaus)
VALUES (E'7', E'lainvoimainen', DEFAULT);
-- ddl-end --
INSERT INTO koodistot.vaihetieto (gid, nimi, kuvaus)
VALUES (E'8', E'keskeytetty', DEFAULT);
-- ddl-end --
INSERT INTO koodistot.vaihetieto (gid, nimi, kuvaus)
VALUES (E'9', E'kumottu', DEFAULT);
-- ddl-end --

-- object: yleiskaava_fk | type: CONSTRAINT --
-- ALTER TABLE yleiskaava.kaavaelementti DROP CONSTRAINT IF EXISTS yleiskaava_fk CASCADE;
ALTER TABLE yleiskaava.kaavaelementti
    ADD CONSTRAINT yleiskaava_fk FOREIGN KEY (uuid_yleiskaava)
        REFERENCES yleiskaava.yleiskaava (uuid) MATCH FULL
        ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --
...
VALUES (E'1', E'tehokkuusluku');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi)
VALUES (E'2', E'kerrosala');
-- ddl-end --
INSERT INTO koodistot.numeerinen_merkintatyyppi (gid, tyyppi)
VALUES (E'3', E'määräaika');
-- ddl-end --
...
ALTER TABLE kaavan_lisatiedot.many_dokumentti_has_many_yleiskaava
...
ALTER TABLE yleiskaava.many_maankayttoalue_has_many_numeerinen_lisatieto
...
ALTER TABLE yleiskaava.many_kaavaelementti_has_many_numeerinen_lisatieto
...
ALTER TABLE yleiskaava.many_kaavaelementti_has_many_teema
    ADD CONSTRAINT kaavaelementti_fk FOREIGN KEY (uuid_kaavaelementti)
        REFERENCES yleiskaava.kaavaelementti (uuid) MATCH FULL
        ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE yleiskaava.many_kaavaelementti_has_many_teema
    ADD CONSTRAINT teema_fk FOREIGN KEY (gid_teema)
...
ALTER TABLE yleiskaava.many_maankayttoalue_has_many_teema
    ADD CONSTRAINT maankayttoalue_fk FOREIGN KEY (uuid_maankayttoalue)
        REFERENCES yleiskaava.maankayttoalue (uuid) MATCH FULL
        ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE yleiskaava.many_yleiskaava_has_many_teema
    ADD CONSTRAINT yleiskaava_fk FOREIGN KEY (uuid_yleiskaava)
        REFERENCES yleiskaava.yleiskaava (uuid) MATCH FULL
        ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
VALUES (E'1', E'yleiskaava', E'0.2.0');
-- ddl-end --
...
ALTER TABLE yleiskaava.many_yleiskaava_has_many_kaavamaarays
    ADD CONSTRAINT yleiskaava_fk FOREIGN KEY (uuid_yleiskaava)
        REFERENCES yleiskaava.yleiskaava (uuid) MATCH FULL
        ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE yleiskaava.many_maankayttoalue_has_many_kaavamaarays
    ADD CONSTRAINT maankayttoalue_fk FOREIGN KEY (uuid_maankayttoalue)
        REFERENCES yleiskaava.maankayttoalue (uuid) MATCH FULL
        ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE yleiskaava.many_kaavaelementti_has_many_kaavamaarays
    ADD CONSTRAINT kaavaelementti_fk FOREIGN KEY (uuid_kaavaelementti)
        REFERENCES yleiskaava.kaavaelementti (uuid) MATCH FULL
        ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
