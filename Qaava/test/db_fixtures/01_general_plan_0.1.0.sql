...
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Asuinalue', E'A', E'Asuntoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Asuinalue', E'AK', E'Kerrostaloalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Asuinalue', E'AP', E'Pientaloalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Asuinalue', E'AT', E'Kyläalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Keskustatoiminnot', E'C', E'Keskusta-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liike- ja toimistorakennusten alue', E'KM',
        E'Kaupallisten palvelujen alue, jolle saa sijoittaa vähittäiskaupan suuryksikön');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'P', E'Palvelujen ja hallinnon alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'PL', E'Lähipalvelujen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Palvelutoiminnot', E'PY', E'Julkisten palvelujen ja hallinnon alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Työpaikka-alue', E'TP', E'Työpaikka-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Teollisuusalue', E'T', E'Teollisuus- ja varastoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Teollisuusalue', E'TT', E'Ympäristövaikutuksiltaan merkittävien teollisuustoimintojen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Teollisuusalue', E'TY', E'Teollisuusalue, jolla ympäristö asettaa toiminnan laadulle erityisiä vaatimuksia');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Teollisuusalue', E'TV', E'Varastoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Teollisuusalue', E'T/kem',
...
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Virkistysalue', E'V', E'Virkistysalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Virkistysalue', E'VL', E'Lähivirkistysalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Virkistysalue', E'VU', E'Urheilu- ja virkistyspalvelujen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Virkistysalue', E'VR', E'Retkeily- ja ulkoilualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Loma- ja matkailualue', E'R', E'Loma- ja matkailualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Loma- ja matkailualue', E'RA', E'Loma-asuntoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Loma- ja matkailualue', E'RM', E'Matkailupalvelujen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Loma- ja matkailualue', E'RL', E'Leirintäalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Loma- ja matkailualue', E'RV', E'Asuntovaunualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Loma- ja matkailualue', E'RP', E'Siirtolapuutarha-/palstaviljelyalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'L', E'Liikennealue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LT', E'Yleisen tien alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'KATU', E'Katualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LHA', E'Henkilöliikenteen terminaalialue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LTA', E'Tavaraliikenteen terminaalialue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LH', E'Huoltoasema-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LR', E'Rautatieliikenteen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LL', E'Lentoliikenteen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Liikenteen alue', E'LS', E'Satama-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'E', E'Erityisalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'ET', E'Yhdyskuntateknisen huollon alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EN', E'Energiahuollon alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EJ', E'Jätteenkäsittelualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EO', E'Maa-ainesten ottoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EK', E'Kaivosalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EA', E'Ampumarata-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EP', E'Puolustusvoimien alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EH', E'Hautausmaa-alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Erityisalue', E'EV', E'Suojaviheralue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Suojelualue', E'S', E'Suojelualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Suojelualue', E'SL', E'Luonnonsuojelualue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Suojelualue', E'SM', E'Muinaismuistoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Suojelualue', E'SR', E'Rakennuslainsäädännön nojalla suojeltava alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Suojelualue', E'SRS', E'Rakennuslainsäädännön nojalla suojeltu alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Maa- ja metsätalousalue', E'M', E'Maa- ja metsätalousvaltainen alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Maa- ja metsätalousalue', E'MT', E'Maatalousalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Maa- ja metsätalousalue', E'ME', E'Kotieläintalouden suuryksikön alue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Maa- ja metsätalousalue', E'MA', E'Maisemallisesti arvokas peltoalue');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Maa- ja metsätalousalue', E'MU',
        E'Maa- ja metsätalousvaltainen alue, jolla on erityistä ulkoilun ohjaamistarvetta');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Maa- ja metsätalousalue', E'MY', E'Maa- ja metsätalousvaltainen alue, jolla on erityisiä ympäristöarvoja');
-- ddl-end --
INSERT INTO koodistot.maankayttoluokka (paaluokka, koodi, nimike)
VALUES (E'Vesialue', E'W', E'Vesialue');
-- ddl-end --
...
VALUES (E'1', E'Maisemallisesti arvokas alue', DEFAULT, E'1');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
...
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'25', E'Moottori- tai moottoriliikennetie', E'mo', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'26', E'Kaksiajoratainen päätie/-katu', E'vt/kt/st/pk', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'27', E'Valtatie/kantatie', E'vt/kt', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'28', E'Seututie/pääkatu', E'st/pk', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'29', E'Yhdystie/kokoojakatu', E'yt/kk', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'30', E'Joukkoliikenteelle varattu tie tai katu', E'jl', E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'31', E'Liittymä', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'32', E'Eritasoliittymä', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'33', E'Suuntaisliittymä', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'34', E'Eritasoristeys ilman liittymää', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'35', E'Liikennetunneli', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'36', E'Päärata ja liikennepaikka', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'37', E'Yhdysrata/sivurata/kaupunkirata', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'38', E'Ulkoilureitti', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'39', E'Kevyen liikenteen reitti', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'40', E'Moottorikelkkailureitti', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'41', E'Laivaväylä', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'42', E'Veneväylä', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'43', E'Johto tai linja', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'44', E'Nykyiset tiet ja linjat', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'45', E'Merkittävästi parannettava tieosuus', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'46', E'Uudet tiet ja linjat', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'47', E'Kunnan raja', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'48', E'Yleiskaava-alueen raja', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'49', E'Alueen raja', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'50', E'Osa-alueen raja', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'51', E'Ohjeellinen alueen tai osa-alueen raja', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'52', E'Poikkiviiva osoittaa rajan sen puolen johon merkintä kohdistuu', DEFAULT, E'2');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'53', E'Keskustatoimintojen alakeskus', E'ca', E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'54', E'Lähipalvelujen alue', E'pl', E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'55', E'Suojelu-/muinaismuistokohde', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'56', E'Virkistys-/matkailukohde', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'57', E'Linja-autoasema/julkisen liikenteen vaihtopaikka/matkakeskus', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'58', E'Rautatieasema', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'59', E'Venesatama/venevalkama', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'60', E'Uimaranta', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'61', E'Kohde, nykyinen ja uusi', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'62', E'Alueeseen tai kohteeseen liittyvä kirjain- tai numerotunnus', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'63', E'Kunnan nimi', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'64', E'Kunnan osan nimi', DEFAULT, E'3');
-- ddl-end --
INSERT INTO koodistot.kaavaelementti_tyyppi (gid, nimi, koodi, gid_geometria_tyyppi)
VALUES (E'65', E'Alakeskuksen/kyläkeskuksen nimi', DEFAULT, E'3');
-- ddl-end --
...
(
    ...
    CONSTRAINT many_dokumentti_has_many_asemakaava_pk PRIMARY KEY (gid_dokumentti, uuid_yleiskaava)
...
VALUES (E'1', E'yleiskaava', E'0.1.0');
-- ddl-end --
